...
<body>
	<%
		...
		session.setAttribute("what", "session!");
		
		application.setAttribute("what", "application");
	%>
<center>
	...
	<table width="600" align="center">
		...
		<tr bgcolor="whitesmoke" height="40">
			...
			<td>Man<input type="radio" size="40" name="gender" checked="checked" value="man">Women<input type="radio" size="40" name="gender" name="women"></td>
		</tr>
		<tr bgcolor="whitesmoke" height="40">
